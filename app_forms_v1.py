...
q8_goldmsi_ae = st.radio("Έχω παρακολουθήσει __ ζωντανές μουσικές εκδηλώσεις ως ακροατής τους τελευταίους δώδεκα μήνες.", ["0", "1", "2", "3", "4-6", "7-10", "11+"], index=None, key="q8_goldmsi_ae", horizontal=True)
q9_goldmsi_ae = st.radio("Ακούω μουσική με προσοχή __ την ημέρα.", ["0-15 λεπτά", "15-30 λεπτά", "30-60 λεπτά", "60-90 λεπτά", "2 ώρες", "2-3 ώρες", "4 ώρες ή περισσότερο"], index=None, key="q9_goldmsi_ae", horizontal=True)
...
st.markdown("**A = ΔΕΝ ΜΕ ΠΕΡΙΓΡΑΦΕΙ ΚΑΘΟΛΟΥ  E = ΜΕ ΠΕΡΙΓΡΑΦΕΙ ΠΟΛΥ ΚΑΛΑ**")

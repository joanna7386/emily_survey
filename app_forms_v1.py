...
q1_bmis = st.radio("Ζωηρός/ή", bmis_options, index=None, key="q1_mood", horizontal=True)
...
q6_bmis = st.radio("Ευχαριστημένος/η (Content)", bmis_options, index=None, key="q6_mood", horizontal=True)
q7_bmis = st.radio("Κακόκεφος/η (Gloomy)", bmis_options, index=None, key="q7_mood", horizontal=True)
...
q14_bmis = st.radio("Τρυφερός/ή (loving)", bmis_options, index=None, key="q14_mood", horizontal=True)
